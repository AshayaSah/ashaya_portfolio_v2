...
export function Footer() {
  return (
    <footer className="relative mx-auto h-full w-full max-w-4xl bg-white dark:bg-neutral-900">
      <div className="flex justify-between border-t border-neutral-100 px-4 py-3 dark:border-neutral-800 md:px-8">
        <p className="text-xs text-neutral-500">Built with love by Mr. Ashaya Sah</p>
