...
function Background() {
  return (
    <div className="absolute inset-0 h-full w-full scale-[1.04] bg-neutral-100 opacity-0 transition-opacity duration-300 group-hover:opacity-100 dark:bg-neutral-800">
